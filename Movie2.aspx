<%@ Page Title="" Language="C#" MasterPageFile="~/SiteNav.Master" AutoEventWireup="true" CodeBehind="Movie2.aspx.cs" Inherits="IT114L_Cinemate_FinalMP.Movie2" %>

<asp:Content ID="Movie2Content" ContentPlaceHolderID="MainContent" runat="server">
    <style>
         body {
         ...
         <div class="seat-selection-container">
             ...
             <div class="theater-layout">
                 ...
                 <div class="movie-poster">
                     <asp:Image ID="imgMoviePoster" runat="server" CssClass="poster-image" ImageUrl="~/Img/SpyFamily.jpg"/>
                 </div>
                 <br />
